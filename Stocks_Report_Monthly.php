...
html_header("Stocks_Report_Monthly");

echo<<<EOT
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Manage Stocks Report Monthly</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="Dashboard.php">Home</a></li>
                <li class="breadcrumb-item active">Manage Stocks Report Monthly</li>
            </ol>
        </nav>
    </div>
    <br>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title" style="text-align: center;">Monthly Stocks Report View</h5>
                <form method="get">
                    <div class="row mb-3">
...
if (isset($_GET['check'])) { 
    $sql = "SELECT * , (SUM(quantity) -SUM(qty)) AS 'avlqty' FROM `sales` LEFT JOIN `stocks` ON sales.stock_id = stocks.s_id LEFT JOIN `products` ON `stocks`.`pro_id` = `products`.`pro_id` WHERE DATE_FORMAT(date, '%Y-%m') ='".$_GET['date']."' GROUP BY stocks.s_id;";
}else{
