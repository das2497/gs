...
<head>
	...
	<title>Disara Trade Center - Login</title>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="credits">
								Designed for <a href="">Disara - Trade Center </a>
							</div>
						</div>
					</div>
				</div>
		...
		if ($stmt->num_rows > 0) {
			...
			if ($post_password == $password) {
				if ($status == 1) {
					...
					echo "<script>alert('Account Banned');document.location='Dashboard.php'</script>"; // login.php
				}
			} else {
				echo "<script>alert('Incorrect Password');document.location='Dashboard.php'</script>"; // login.php
			}
			echo $password;
		} else {
			echo "<script>alert('Incorrect User Name');document.location='Dashboard.php'</script>"; // login.php
		}
		$stmt->close();
	}
}
